...
\[ EVB(e_k) = v_{\pi _{\text{new}}} (s_k) - v_{\pi _{\text{old}}} (s_k) = \sum _a \pi _{\text{new}} (a\mid s_k) q_{\pi _{\text{new}}}(s_k,a) - \sum _a \pi _{\text{old}} (a\mid s_k) q_{\pi _{\text{old}}}(s_k,a)\]
...
\[\mid EVB(e_k) \mid \leq \alpha \mid TD(s_k, a_k, r_k, s_{k+1})\mid \]
...
[fn:9] [[S. Fujimoto /et. al./, "An Equivalence between Loss Functions and Non-Uniform Sampling in Experience Replay" (2020) arXiv:2007.06049]]
