...
{{% button href="https://ymd_h.gitlab.io/cpprb/installation/" icon="fas fa-download" icon-position="right" %}}Get Started{{% /button %}}

** Make Reinforcement Learning Easier
Experience Replay is widely used for off-policy reinforcement
learning. With cpprb, you can start your experiment without
...
rb = ReplayBuffer(1000,
                  {"obs": {"shape": (16,16), "dtype": np.float16},
                   "act": {"dtype": np.int32},
                   "reward": {},
                   "next_obs": {"shape": (16,16), "dtype": np.float16},
                   "done": {},
                   "second_reward": {},
                   "next_act": {},
                   "next_next_obs": {"shape": (16,16), "dtype"}})
#+end_src

cpprb adopts flexible environment. Any numbers of [[https://numpy.org/][Numpy]] compatible
environment values can be stored.

{{% button href="https://ymd_h.gitlab.io/cpprb/features/flexible_environment/" icon="fas fa-angle-double-right" icon-position="right" %}}Learn More{{% /button %}}

** Fast
Heavy calculation is implemented with C++ and [[https://cython.org/][Cython]]. cpprb is much
...
** Ecosystem (cpprb users)

*** TF2RL
{{% button href="https://github.com/keiohta/tf2rl" %}}Go Repository{{% /button %}}


** Community

{{% button href="https://github.com/ymd-h/cpprb/discussions" icon="fas fa-comments" icon-position="right" %}}User Forum{{% /button %}}
* Installation
:PROPERTIES:
