...
If \(1/c_{\text{max}} < \rho _t < c_{\text{max}}\) then it classified
...
\[ \beta \leftarrow \cases{ (1-\eta )\beta & \text{if} n_{\text{far}/N} > D \\ (1-\eta )\beta + \eta & \text{otherwise}} \]
...
** References
- [[http://proceedings.mlr.press/v97/novati19a.html][G. Novati and P. Koumoutsakos, "Remember and Forget for Experience Replay", PMLR (2019) 97, 4851-4860]] ([[https://arxiv.org/abs/1807.05827][arXiv]], [[https://github.com/cselab/smarties][code]])
