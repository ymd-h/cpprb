...
[[https://sphinx-automodapi.readthedocs.io/en/latest/][sphinx-automodapi]] to build the module structure. Unfortunately, there
is an unfixed bug [[https://gitlab.com/ymd_h/cpprb/-/issues/118][#118]], all methods are described twice (Why?).
